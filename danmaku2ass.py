...
# Thanks for the above contributer. (by ZhiyuShang)
# ASS FOV = width*4/3.0
...
def WriteASSHead(f, width, height, fontface, fontsize, alpha, styleid):
    f.write(
        '''[Script Info]
; Script generated by Danmaku2ASS-Simplfy
; https://github.com/1299172402/danmu2ass-simply
Script Updated By: Danmaku2ASS-Simplfy (https://github.com/1299172402/danmu2ass-simply)
ScriptType: v4.00+
PlayResX: %(width)d
PlayResY: %(height)d
...
def main():
    ...
    if os.path.isfile(args.file[0]):
        ...
        print(f"[2ASS Succeed] {args.file[0]}")
